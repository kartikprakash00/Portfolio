    ...
    return (
        <div id='home' className='hero'>
            ...
            <div className='hero-action'>
                ...
                <a className='download' href="https://drive.google.com/file/d/1-EIv_CG_5mBE9z-FsW8FtTQIbMkHXvPd/view?usp=share_link"><div className="hero-resume">My résumé</div></a>
            </div>
        </div>
    )
}
